...
class CapstoneTestCase(unittest.TestCase):
    ...
    def test_get_movies(self):
        res = self.client().get('/movies', headers={'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlIxOWRvRGNmak9jQThMYjFXMkFScyJ9..GlefvUpwCeu9JlPofW7IL6m5pehN31cz_v7MffqaMI-mRVC1kCl12vJ1M54Q7imtKGkKXj9vqYTZmmY14Ug7KOhZbpHaMaU3-dR9I__x2c3dxx3rHfHV4vaEc43d1kMet_SB1ieT-3VqyxZCP4C274lk3FEAlGSTac_xtQ9YBu5J75s5EahnPotiD1R8aLE4qxrwNyUyvWGGmzRgc2xi3DyuwKzKUkVK-IOOKQjG8zJcQlxA7hXnP2UYLUqoSH9zQZ688PK-oa494QfwNGS0vmrN3PC-_XmzHrIl6DDfugBdixBnofa8s4nIXU7IxVGIbIm3fgQaeTc31JltmzdT3A'})
    ...
    def test_get_actors(self):
        res = self.client().get('/actors', headers={'Authorization': 'Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlIxOWRvRGNmak9jQThMYjFXMkFScyJ9..GlefvUpwCeu9JlPofW7IL6m5pehN31cz_v7MffqaMI-mRVC1kCl12vJ1M54Q7imtKGkKXj9vqYTZmmY14Ug7KOhZbpHaMaU3-dR9I__x2c3dxx3rHfHV4vaEc43d1kMet_SB1ieT-3VqyxZCP4C274lk3FEAlGSTac_xtQ9YBu5J75s5EahnPotiD1R8aLE4qxrwNyUyvWGGmzRgc2xi3DyuwKzKUkVK-IOOKQjG8zJcQlxA7hXnP2UYLUqoSH9zQZ688PK-oa494QfwNGS0vmrN3PC-_XmzHrIl6DDfugBdixBnofa8s4nIXU7IxVGIbIm3fgQaeTc31JltmzdT3A'})
        data = json.loads(res.data)
    ...
    def test_401_if_token_is_invalid(self):
        res = self.client().get('/actors', headers={'Authorization': 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlIxOWRvRGNmak9jQThMYjFXMkFScyJ9..GlefvUpwCeu9JlPofW7IL6m5pehN31cz_v7MffqaMI-mRVC1kCl12vJ1M54Q7imtKGkKXj9vqYTZmmY14Ug7KOhZbpHaMaU3-dR9I__x2c3dxx3rHfHV4vaEc43d1kMet_SB1ieT-3VqyxZCP4C274lk3FEAlGSTac_xtQ9YBu5J75s5EahnPotiD1R8aLE4qxrwNyUyvWGGmzRgc2xi3DyuwKzKUkVK-IOOKQjG8zJcQlxA7hXnP2UYLUqoSH9zQZ688PK-oa494QfwNGS0vmrN3PC-_XmzHrIl6DDfugBdixBnofa8s4nIXU7IxVGIbIm3fgQaeTc31JltmzdT3A'})
        data = json.loads(res.data)
